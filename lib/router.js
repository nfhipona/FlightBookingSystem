...
module.exports = (app, database, auth) => {
    ...
    app.post    ('/paypal/pay',                                     auth.verifyWithType('user_token'),              acl('name_later', 'w'),                                    paypal.checkout                                  );
    app.get     ('/paypal/execute_pay',                             auth.verifyWithType('user_token'),              acl('name_later', 'w'),                                    paypal.execute                                   );
