...
module.exports = (app, database, auth) => {
    ...
    app.post    ('/airlines',                                       auth.validate_token('user_token'),              acl('name_later', 'w'),                                    airline.create                                   );
    app.get     ('/airlines',                                       auth.validate_token('user_token'),              acl('name_later', 'r'),                                    airline.fetch                                    );
}